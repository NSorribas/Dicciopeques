 ...
 */
async function main() {
  console.log('=== DiccioPeques — Palabra del Día ===');
  ...
  // 2. Seleccionar la palabra del día
  ...
  const payload = {
    ...
    badge: './assets/icons/icon-192x512.png',
    url: './index.html'
  };

  console.log(`[2/3] Palabra del día: ${palabraDelDia.palabra}`);

  // 3. Obtener suscripciones y enviar
  console.log('[3/3] Obteniendo suscripciones...');
