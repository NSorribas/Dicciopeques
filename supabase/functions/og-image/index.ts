// DiccioPeques — Edge Function: Dynamic OG PNG Image Generator
// Generates a 1200x630 PNG with the word, category and definition
            ...
            props: {
              ...
              children: [
                ...
                categoria ? {
                  ...
                  props: {
                    style: {
                      fontSize: '26px', fontStyle: 'italic', color: '#d4a843',
                    },
                    children: categoria + '.',
                  },
                } : null,
